...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "5-star rated North Indian catering for birthdays, baby showers and family celebrations in Dartford. Real flavours, generous portions and stress-free service",
