# Lehsun Catering Pricing

Last updated: 2026-09-02

Lehsun provides North Indian catering from Ebbsfleet Valley for events across Dartford, Gravesend, Northfleet, Bexley, Orpington and nearby Kent.

## Starting price

- Catering starts from GBP 11.99 per head.
- Minimum catering size is 12 guests.
- Lehsun has catered events of up to 125 guests.
- Final pricing depends on guest count, menu selection, number of courses, vegetarian and non-vegetarian mix, and event requirements.

## What catering can include

Catering menus can include:

- Vegetarian starters
- Vegetarian mains
- Rice and pulao
- Breads such as naan and poori
- Raita
- Desserts
...
Core catering areas include:

- Ebbsfleet Valley and DA10
- Dartford, DA1 and DA2
- Gravesend, DA11 and DA12
- Northfleet
- Bexley
- Orpington
- Nearby Kent
...
For a tailored catering quote, send the event date, guest count, event location, dietary requirements and preferred dishes.

- WhatsApp: https://wa.me/447768892652?text=Hi%20Lehsun%2C%20I%27d%20like%20to%20enquire%20about%20catering%20for%20my%20event.
